            ...
            <div class ="s">
                ...
                <div class="menu container">
                    ...
                    <div class="logoContainer">
                        <img style="width: 50px;" src="image/bartender.png" alt=""/>
                        <a href="Bartender.jsp" class="logo" >Bartender</a> 
                    </div>
            ...
            <div class="lateral-var">
                <div  class="botton-container">
                    <%
                        ...
                        ArrayList<Order> viewBartender = mysql.getOrderBartender(table);
                    ...
                    <div>
                        ...
                        <form action="Bartender.jsp" method="POST">
                ...
                <div class="row">
                    <div class="col">
                        <table class="table table-bordered" border="1" >
                            ...
                            <tbody>
                                <%
                                    for (int i = 0; i < viewBartender.size(); i++) {
                                        String stringStatus = viewBartender.get(i).getStatus() + "";
                                        System.out.println(viewBartender.get(i).getNumTable());
                                        String urlCheckbox = "";
                                        if (viewBartender.get(i).getStatus() == 1) {
                                ...
                                %>
                                <tr>
                                    <td hidden="true"><%=viewBartender.get(i).getIdOrder()%></td>
                                    <td hidden="true"><%=viewBartender.get(i).getIdProduct()%></td>
                                    <td><%=viewBartender.get(i).getNombre()%></td>
                                    <td><%=viewBartender.get(i).getQuantity()%></td>
                                    <td><%=viewBartender.get(i).getPrice()%></td>
                                    <td><%=viewBartender.get(i).getComment()%></td>
                                    <td><%=stringStatus.equalsIgnoreCase("1")
                                            ? "No listo"
                                            : "Listo"%></td>
                                    <td> 
                                        <form action="OrderReady.jsp">
                                            <input hidden="true" type="text" name="order" value="<%= viewBartender.get(i).getIdOrder()%>">
                                            <input hidden="true" type="text" name="status" value="<%= viewBartender.get(i).getStatus()%>">
                                            <input hidden="true" type="text" name="table" value="<%= table%>">
                                            <input hidden="true" type="text" name="nameJSP" value="Bartender">
